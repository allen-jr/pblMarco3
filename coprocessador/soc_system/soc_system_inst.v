	soc_system u0 (
		...
		.pio_ctrl_external_connection_export     (<connected-to-pio_ctrl_external_connection_export>),     //     pio_ctrl_external_connection.export
		.pio_data_in_external_connection_export  (<connected-to-pio_data_in_external_connection_export>),  //  pio_data_in_external_connection.export
		.pio_data_out_external_connection_export (<connected-to-pio_data_out_external_connection_export>), // pio_data_out_external_connection.export
		.reset_reset_n                           (<connected-to-reset_reset_n>),                           //                            reset.reset_n
		.vga_data_external_connection_export     (<connected-to-vga_data_external_connection_export>),     //     vga_data_external_connection.export
		.vga_ctrl_external_connection_export     (<connected-to-vga_ctrl_external_connection_export>)      //     vga_ctrl_external_connection.export
	);
